...
//call the signup method
        [user signUpInBackgroundWithBlock:^(BOOL succeeded, NSError * _Nullable error) {
            ...
            if (!succeeded){
                UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Alert" message:@"You could not be registered at this time. Please try again, later." preferredStyle:UIAlertControllerStyleAlert];
                UIAlertAction *okayButton = [UIAlertAction actionWithTitle:@"Okay"
                                                                     style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
...
// Display alert
            ...
            UIAlertController *alert = [UIAlertController alertControllerWithTitle:@"Alert" message:@"Registration was Successful!" preferredStyle:UIAlertControllerStyleAlert];
            UIAlertAction *okayButton = [UIAlertAction actionWithTitle:@"Okay"
                                                                 style:UIAlertActionStyleDefault handler:^(UIAlertAction *action) {
